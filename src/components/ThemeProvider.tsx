...
function applyThemeTokens(
  ...
  const lightTheme = {
    '--color-bg': '#f7f9f7',
    '--color-bg-elevated': '#eff3f0',
    '--color-bg-muted': '#e2e9e4',
    '--color-surface': '#ffffff',
    '--color-surface-strong': '#fdfdfd',
    '--color-card': 'rgba(255, 255, 255, 0.9)',
    '--color-card-muted': 'rgba(245, 248, 246, 0.8)',
    '--color-text': '#1a2e25',
    '--color-text-muted': '#4d665b',
    '--color-text-subtle': '#758c82',
    '--color-border': 'rgba(26, 46, 37, 0.08)',
    '--color-border-strong': 'rgba(26, 46, 37, 0.14)',
    ...
    '--shadow-glow': '0 12px 40px rgba(var(--theme-neon-rgb), 0.1)',
    '--shadow-card': '0 32px 64px rgba(26, 46, 37, 0.06)',
  };
