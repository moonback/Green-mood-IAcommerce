        ...
        try {
            ...
            await Promise.all([
                supabase.from('store_settings').upsert([
                    ...
                    { key: 'budtender_voice_name', value: globalSettings.budtender_voice_name, updated_at: new Date().toISOString() },
                    { key: 'budtender_name', value: globalSettings.budtender_name, updated_at: new Date().toISOString() },
