...
export default function ProductSpecs({ specs }: Props) {
  ...
  return (
    <section id="specs" className="mx-auto max-w-[1400px] px-4 py-5 sm:px-6 lg:px-8 scroll-mt-24">
      {/* ── Header ── */}
      <div className="mb-12 relative flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-[color:var(--color-border)] pb-8">
        ...
        <div className="flex items-center p-1 rounded-xl bg-[color:var(--color-bg-muted)] border border-[color:var(--color-border)] shadow-inner">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all duration-300 ${viewMode === 'details'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all duration-300 ${viewMode === 'grid'
              ? 'bg-[color:var(--color-card)] text-[color:var(--color-primary)] shadow-sm scale-100'
              : 'text-[color:var(--color-text-subtle)] hover:text-[color:var(--color-text)] scale-95 hover:scale-100'
              }`}
          >
                    ...
                    {items.map((spec) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative group flex items-center justify-between px-5 py-3.5 rounded-2xl text-left transition-all duration-300 ${isActive
